...
export class InitMigration1773624575759 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "transactions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "type" character varying(50) NOT NULL, "amount" numeric(12,2) NOT NULL, "category" character varying(100) NOT NULL, "account" character varying(100) NOT NULL, "description" text, CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "size" bigint NOT NULL, "bucket" character varying(255) NOT NULL, "key_s3" character varying(512) NOT NULL, "module" character varying(100) NOT NULL, "ref_id" character varying(50) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ac51aa5181ee2036f5ca482857c" PRIMARY KEY ("id"))`);
